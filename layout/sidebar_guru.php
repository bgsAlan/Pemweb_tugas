...
<div class="sidebar d-none d-lg-block p-3">
    <h4 class="text-white mb-4">PanelGuru</h4>
...
<div class="offcanvas offcanvas-start text-bg-dark"
    ...
    <div class="offcanvas-header">
        <h5 class="offcanvas-title">PanelGuru</h5>
    ...
    <div class="offcanvas-body">
        ...
        <a href="dashboard_guru_view.php" class="d-block text-white mb-3 text-decoration-none">
            <i class="bi bi-speedometer2"></i> Dashboard
        </a>

        <a href="presensi_guru_view.php" class="d-block text-white mb-3 text-decoration-none">
            <i class="bi bi-calendar-check"></i> Presensi
        </a>
